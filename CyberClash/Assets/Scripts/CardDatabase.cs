...
public class CardDatabase : MonoBehaviour
{
    ...
    void Awake()
    {
        ...
        cardList.Add(new Card(18, "Test Card10", "Universal", "Utility", 2, 0, "Restore system files.\nHeal 100 Health.", Resources.Load<Sprite>("NoImage"), 1, 100));
        cardList.Add(new Card(19, "Test Card11", "Universal", "Utility", 3, 0, "Sample.", Resources.Load<Sprite>("NoImage"), 0, 0));
        cardList.Add(new Card(20, "Test Card12", "Threat", "Offense", 4, 150, "Sample.", Resources.Load<Sprite>("NoImage"), 0, 0));
    }
}
